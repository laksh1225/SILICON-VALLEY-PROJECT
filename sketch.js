...
//Variable for score
 ...
 function preload(){
  //For loding the image for the backbackgr
    backgr_Img = loadImage("bg.jpeg");

    girl_running = loadAnimation("1.png" , "2.png" , "3.png" , "4.png" , "5.png" , "6.png" , "7.png" , "8.png")
    girl_ = loadImage("8.png");

   //For loading the images for the junk food 
    pizzaImg = loadImage("Junk food 3.PNG");
    burgerImg = loadImage("Junk food 1.PNG");
    donutsImg = loadImage("Junk food 2.PNG");
   
   //For loading the images for the healthy food
    grapesImg = loadImage("Healthy food 1.PNG");
    cornImg = loadImage("Healthy food 2.PNG");
    saladImg = loadImage("Healthy food 3.PNG");
 
   //For loading images for workout equipment
    dumbbellImg = loadImage("Workout 1.PNG");
    jumpRopeImg = loadImage("Workout 2.PNG");
    threadmillImg = loadImage("Workout 3.PNG");
